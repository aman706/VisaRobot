...
from VisaRobot.events import register as Visa
...
async def send(event):
    ...
    the_plugin_file = "./VisaRobot/modules/{}.py".format(input_str)
        ...
        try:
            downloaded_file_name = (
                await event.client.download_media(  # pylint:disable=E0602
                    ...
                    "VisaRobot/modules/",  # pylint:disable=E0602
                )
            )
