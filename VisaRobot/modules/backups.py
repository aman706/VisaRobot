...
import VisaRobot.modules.sql.notes_sql as sql
from VisaRobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from VisaRobot.__main__ import DATA_IMPORT
from VisaRobot.modules.helper_funcs.chat_status import user_admin
from VisaRobot.modules.helper_funcs.alternate import typing_action

# from VisaRobot.modules.rules import get_rules
import VisaRobot.modules.sql.rules_sql as rulessql

# from VisaRobot.modules.sql import warns_sql as warnssql
import VisaRobot.modules.sql.blacklist_sql as blacklistsql
from VisaRobot.modules.sql import disable_sql as disabledsql

# from VisaRobot.modules.sql import cust_filters_sql as filtersql
# import VisaRobot.modules.sql.welcome_sql as welcsql
import VisaRobot.modules.sql.locks_sql as locksql
from VisaRobot.modules.connection import connected
...
def export_data(update, context):
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("VisaRobot{}.backup".format(chat_id), "rb"),
        caption="💾*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `VisaRobot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("VisaRobot{}.VisaRobot".format(chat_id))  # Cleaning file
