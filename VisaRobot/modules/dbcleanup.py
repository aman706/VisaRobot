...
import VisaRobot.modules.sql.global_bans_sql as gban_sql
import VisaRobot.modules.sql.users_sql as user_sql
from VisaRobot import DEV_USERS, OWNER_ID, dispatcher
