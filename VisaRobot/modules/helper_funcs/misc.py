...
def paginate_modules(page_n: int, module_dict: Dict, prefix, chat=None) -> List:
    ...
    if len(pairs) > 8:
        ...
        pairs += [[EqInlineKeyboardButton("Back", callback_data="asuna_back"), EqInlineKeyboardButton("💾 Repository", url="https://github.com/HuntingBots/AsunaRobot") ]]
