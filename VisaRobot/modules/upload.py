...
from VisaRobot import telethn as bot
from VisaRobot.modules.urluploader import download_file
from VisaRobot.utils.uputils import humanbytes, progress
    ...
    if event.reply_to_msg_id:
        ...
        try:
            ...
            await bot.send_file(
                ...
                dosya,
                force_document=True,
                caption=f"Uploaded By *VisaRobot*",
            )
        except Exception as e:
            traceback.print_exc()
